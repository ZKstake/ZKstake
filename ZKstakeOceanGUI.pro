...
# Input
DEPENDPATH += .
HEADERS += src\zkstake_globals.h \
     src\qt\zkstakeoceangui.h \
     ...
     src\qt\zkstakeaddressvalidator.h \
     ...
     src\streams.h \
     src\zkstake_bitcoind.h \
     src\zkstake_utils.h \
     src\zkstake_notary.h \
     src\zkstake_gateway.h
...
SOURCES += src\protobuf\google\protobuf\any.cc \
    ...
    src\qt\intro.cpp \
    src\qt\zkstake.cpp \
    src\qt\zkstakeaddressvalidator.cpp \
    src\qt\zkstakeamountfield.cpp \
    src\qt\zkstakeoceangui.cpp \
    src\qt\zkstakeunits.cpp \
...
# also add new translations to zkstake.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/zkstake_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md src/qt/res/zkstake-qt-res.rc
...
windows:RC_FILE = src/qt/res/zkstake-qt-res.rc
...
macx:ICON = src/qt/res/icons/zkstake.icns
macx:TARGET = "ZKstakeOceanGUI"
