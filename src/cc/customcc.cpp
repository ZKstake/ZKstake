/*
 ...
 Just update the functions in this file, then from ~/zkstake/src/cc
 
 ../zkstake-cli -ac_name=CUSTOM stop
 ./makecustom
 ../zkstaked -ac_name=CUSTOM -ac_cclib=custom -ac_cc=2 ...
 
 The above will rebuild zkstaked and get it running again
 */
...
{
    CMutableTransaction mtx = CreateNewContextualCMutableTransaction(Params().GetConsensus(), zkstake_nextheight()); std::string rawtx;
