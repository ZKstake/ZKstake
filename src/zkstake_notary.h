...
#define ZKSTAKE_MAINNET_START 178999
#define ZKSTAKE_NOTARIES_HEIGHT1 814000
#define ZKSTAKE_NOTARIES_HEIGHT2 2588672
...
int32_t zkstake_notaries(uint8_t pubkeys[64][33],int32_t height,uint32_t timestamp);
void zkstake_notarysinit(int32_t origheight,uint8_t pubkeys[64][33],int32_t num);
void zkstake_notaries_uninit(); // gets rid of values stored in statics
void zkstake_statefile_uninit(); // closes statefile

extern struct knotaries_entry *Pubkeys;
#define ZKSTAKE_STATES_NUMBER 2
extern struct zkstake_state ZKSTAKE_STATES[];