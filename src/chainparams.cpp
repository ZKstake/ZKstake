...
public:
    CMainParams()
    {
        ...
        genesis.nBits    = ZKSTAKE_MINDIFF_NBITS;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("zkstake.com", "explorer.zkstake.com")); // dev
        vSeeds.push_back(CDNSSeedData("n1.zkstake.com", "node1.zkstake.com")); // dev
        vSeeds.push_back(CDNSSeedData("n2.zkstake.com", "node2.zkstake.com")); // dev
...
void zkstake_setactivation(int32_t height)
{
