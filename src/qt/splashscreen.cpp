    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightText   = QString::fromUtf8(CopyrightHolders(strprintf("\xc2\xA9 %u-%u ", COPYRIGHT_YEAR)).c_str());
    ...
    // draw the zkstake icon, expected size of PNG: 1024x1024
    // QRect rectIcon(QPoint(-150,-122), QSize(430,430));
    // QRect rectIcon(QPoint(-50,-10), QSize(350,350));
   QRect rectIcon(QPoint(5,15), QSize(180,180));
    ...
    if(!titleAddText.isEmpty()) {
        QFont boldFont = QFont(font, 7*fontFactor);
