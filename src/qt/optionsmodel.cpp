...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", ZKstakeUnits::KMD);
    nDisplayUnit = settings.value("nDisplayUnit").toInt();

    std::string defaultStrThirdPartyTxUrls = "https://zkstake.explorer.us/tx/%s|https://zkstake.explorer.dexstats.info/tx/%s";
...
void OptionsModel::checkAndMigrate()
{
    ...
    if (settingsVersion < CLIENT_VERSION)
    {
        ...
        // see https://github.com/zkstake/zkstake/pull/8273
