...
#ifndef ZKSTAKE_QT_ZKSTAKEUNITS_H
#define ZKSTAKE_QT_ZKSTAKEUNITS_H
...
/** ZKstake unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ZKstakeUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ZKstakeUnits(QObject *parent);

    /** ZKstake units.
      @note Source: https://en.zkstake.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        KMD,
...
typedef ZKstakeUnits::Unit ZKstakeUnit;

#endif // ZKSTAKE_QT_ZKSTAKEUNITS_H
